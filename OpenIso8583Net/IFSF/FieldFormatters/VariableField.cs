...
{
    public class VariableField : AField
    {
        /// <summary>
        ...
        public VariableField(int fieldNumber, IFieldValidator fieldValidator, int lengthIndicator,
            int maxLength)
            : this(
                fieldNumber,
                fieldValidator,
                new AsciiFieldFormatter(),
                new AsciiFieldFormatter(),
                lengthIndicator,
                maxLength)
        {
        ...
        public VariableField(int fieldNumber, IFieldValidator fieldValidator, IFieldFormatter fieldFormatter,
